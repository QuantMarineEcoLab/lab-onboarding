...
We have a document in the shared Google drive focused on lab offboarding, the process that describes what happens when someone leaves the lab. Here is a brief summary of the process.

- Ensure that all data (including raw data sheets) and code is available in a public repository or in the QuantMarineEcoLab Github, GoogleDrive, or Sharepoint folders
...
- Return any lab equipment (e.g., books, computer accessories, field equipment)
...
- Compile a list (of activities during your time in the lab) of all your grants awarded, publications submitted and accepted, classes taught, and outreach activities (this can be take from your previous progress updates)
